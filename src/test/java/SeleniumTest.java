...
public class SeleniumTest {
    ...
    public void testFoodProductIsSubclass() {
        ...
        assertTrue(foodClass.toString().contains("FoodProduct extends Product"));
    }

    @Test
    public void testFoodProductContainsCorrectState() {
        System.out.println(foodClass);
        assertTrue(foodClass.toString().contains("#expirationDate"));
    }

    @Test
    public void testFoodProductContainsCorrectConstructor() {

        assertTrue(foodClass.toString().contains("FoodProduct"));
        assertTrue(foodClass.toString().contains("name"));
        assertTrue(foodClass.toString().contains("description"));
        assertTrue(foodClass.toString().contains("expirationDate"));
        assertTrue(foodClass.toString().contains("this.#expirationDate"));
    }

    @Test
    public void testFoodProductContainsCorrectMutators() {

        assertTrue(foodClass.toString().contains("getExpirationDate()"));
        assertTrue(foodClass.toString().contains("setExpirationDate("));
        assertTrue(foodClass.toString().contains("expirationDate"));
    }
